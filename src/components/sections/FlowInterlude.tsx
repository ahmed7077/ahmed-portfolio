...
export function FlowInterlude() {
  ...
  return (
    <section ref={ref} className="relative h-[82vh] min-h-[640px] overflow-hidden bg-[#1e3a34] text-[#f5f1e8]">
      <motion.div style={{ y: far }} className="absolute inset-[-10%] opacity-50">
      ...
      <motion.div style={{ y: near }} className="absolute -bottom-40 left-[8%] h-[520px] w-[520px] rounded-full border border-[#c49a57]/20">
      ...
      <Container className="relative flex h-full flex-col justify-center">
        ...
        <h2 className="max-w-5xl font-display text-[clamp(3.6rem,9vw,9rem)] leading-[.84] tracking-[-.06em]">
          Intelligence<br /><em className="font-light text-[#c49a57]">should move.</em>
        </h2>
        <div className="mt-12 grid max-w-3xl grid-cols-3 border-y border-[#f5f1e8]/12 py-6">
